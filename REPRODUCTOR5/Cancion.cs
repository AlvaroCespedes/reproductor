...
namespace REPRODUCTOR5
{
    ...
    {
        // Hay que poner en el constructor eeee
        // un elemento del arreglo que subamos

        private string composer;
        private string singer;
        private string album; //AGERGAR A SUS RESPECTIVAS CLASES
        private string lyrics; //BORRAR AHORA
        ...
        private int duration;// SE PUEDE SABER
        private int memory; // SEPUEDE SABER
        ...
        public Cancion(string gender, string publicationYear,
